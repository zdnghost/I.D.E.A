...
function getOderDetail($bill){
    ...
    global $dp;
    $sql2="SELECT * from sanpham join chitiethoadon on sanpham.idsanpham=chitiethoadon.idsanpham and sanpham.idmau=chitiethoadon.idmau join mau on  sanpham.idmau=mau.idmau where idnguoidung=".$_SESSION['userID'];
